...
const DefaultDashboardHeader = () => {
    const menu1 = (
        <>
            ...
            <Contact />
            <li>
                <Link to='/blog'><div className="dropdown dropdown-hover">
                    <summary role="button" className="hover:border-b-2  border-blue-500">Blog</summary></div>
                </Link>
            </li>
        </>
    );
...
export default DefaultDashboardHeader;
