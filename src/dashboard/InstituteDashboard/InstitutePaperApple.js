...
const InstitutePaperApple = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center w-full mx-auto'>
            ...
            <caption className='bg-secondary h-12 w-full text-center  text-2xl text-white'>PhD Certificate  Apple</caption>
            <form className='form grid grid-cols-2 gap-x-3 mx-auto min-h-screen w-11/12 bg-base-100'>
                {
                    institutePaperApple.map(input => <li key={input.id}
                        className='menu'>
            ...
            <button className='btn btn-primary w-11/12 mx-auto p-2 my-4 btn-outline text-lg'>Apple Now</button>
        </div>
    );
};

export default InstitutePaperApple;