...
const UserPaper = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center w-full mx-auto'>
            ...
            <caption className='bg-secondary h-12 w-full text-center  text-2xl text-white'>Enter Your PHD Certificate Information</caption>
            <form className='form grid grid-cols-2 gap-x-3 mx-auto min-h-screen w-11/12 bg-base-100'>
                {
                    userPaper.map(input => <li key={input.id}
                        className='menu'>
