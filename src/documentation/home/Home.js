...
const Home = () => {
  return (
    <div div className="w-3/4 mx-auto bg-base-100 text-justify p-5 flex flex-col justify-center items-center" >
      ...
      <h1 className="text-4xl text-secondary pb-4">About Philosophy of Doctorate (PhD) certificate...!!!</h1>
      <button className="btn btn-primary btn-outline rounded-full">Get start for verify now</button>
      <div className='border-2 border-purple-900 p-5 m-5'>
        <span className='font-semibold text-primary'>Welcome to the official website of "PhD Verify certificate",</span> This website contains information about <Link to='/' className='link'>Phd Certificate</Link>  and its organizational structure, wings, functionality, and resposibilities. This website also contains information about Education Sector Development Program of Bangladesh.
      </div>
      <div className='border-2 border-purple-900 p-5 m-5'>
